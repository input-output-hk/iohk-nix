...
fix (self: mappedPkgs // {
  ...
  cardano-deployment = cardanoLib.mkConfigHtml { inherit (cardanoLib.environments) mainnet testnet shelley_qa shelley_testnet mainnet_candidate staging shelley_staging; };
