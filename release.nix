...
fix (self: mappedPkgs // {
  ...
  cardano-deployment = cardanoLib.mkConfigHtml { inherit (cardanoLib.environments) mainnet testnet p2p alonzo-purple marlowe-dev marlowe-pioneers staging shelley_qa sre; };
