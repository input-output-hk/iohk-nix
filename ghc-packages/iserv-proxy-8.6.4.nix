{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/iserv-proxy-8.6.4.tar.gz; sha256 = "18srgpxxn95l4jp2jrhm21m2ww1y692md4fdgp121ksyn3vpsz1m"; }; }
