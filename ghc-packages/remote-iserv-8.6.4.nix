{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/remote-iserv-8.6.4.tar.gz; sha256 = "1rc2cwpvi44klwc76l02wc3xxwih98261w3fyklh379xjla2di99"; }; }
