{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/iserv-proxy-8.6.5.tar.gz; sha256 = "12p15pk64z5h1kgqzr2vpqvyr0v6kzglm0l633dphsdc8wv57qlj"; }; }
