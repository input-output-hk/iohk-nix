{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/ghc-boot-8.4.4.tar.gz; sha256 = "0nzib497q0a80czz266br6jzmg9pv3nfhga59ay577vg17k4gaxy"; }; }
