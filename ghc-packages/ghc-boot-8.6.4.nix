{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/ghc-boot-8.6.4.tar.gz; sha256 = "0l9izdh1afrqvkn7im3f35bdd872vr38cbbnkssdvmzl5nq418jn"; }; }
