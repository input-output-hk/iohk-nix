{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    } // rec { src = pkgs.fetchurl { url = http://releases.mobilehaskell.org/ghc-packages/remote-iserv-8.6.5.tar.gz; sha256 = "0y1yr6myvh7zrpz0lcianrsfvirr02xs6g4k40dxmknqyd8rmxqv"; }; }
