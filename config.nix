  ...
  in rec {
   ...
   libmpc = ps.libmpc.overrideAttrs (drv: {
    ...
    haskell = lib.recursiveUpdate ps.haskell {
      ...
      compiler.ghc862 = (ps.haskell.compiler.ghc863.override ghcPkgOverrides).overrideAttrs ghcDrvOverrides;
      compiler.ghc863 = (ps.haskell.compiler.ghc862.override ghcPkgOverrides).overrideAttrs ghcDrvOverrides;
    };
  };
}
